...
public class Assignment4 {
    ...
    public static void main(String[] args) {
        // Adding few Traders
        Trader t1 = new Trader("Balaji", "Bangalore");
        Trader t2 = new Trader("babu", "Pune");
        Trader t3 = new Trader("shane", "Delhi");
        Trader t4 = new Trader("mendy", "Bhubaneswar");
        Trader t5 = new Trader("harsha", "Pune");
        Trader t6 = new Trader("kaveesh", "Indore");
