...
public class Assignment3 {
    ...
    public static void main(String[] args) {
        ...
        t.add(new Trader("Balaji", "Bangalore"));
        t.add(new Trader("babu", "Pune"));
        t.add(new Trader("shane", "Delhi"));
        t.add(new Trader("mendy", "Bhubaneswar"));
        t.add(new Trader("harsha", "Pune"));
        t.add(new Trader("kaveesh", "Indore"));
