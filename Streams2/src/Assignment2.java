...
public class Assignment2 {
    ...
    public static void main(String[] args) {
        ...
        feb23.add(new News(1, "mithun", "haran", "comment"));
        feb23.add(new News(2, "balaji", "raj", "comment"));
        feb23.add(new News(3, "ravindra", "murali", "budget"));
        feb23.add(new News(2, "balaji", "kaveesh", "budget "));
        feb23.add(new News(1, "balaji", "shane", "costly"));
        feb23.add(new News(3, "shane", "murali", "costly"));
